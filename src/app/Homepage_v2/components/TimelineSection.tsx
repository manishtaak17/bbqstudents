...
export default function TimelineScrollSection() {
      ...
      if (sectionInView) {
        ...
        if (totalScroll > 0) {
          const canScrollHorizontally =
            (horizontalProgress < 1 && e.deltaY > 0) ||
            (horizontalProgress > 0 && e.deltaY < 0)
      ...
      <div className="w-full overflow-hidden px-[20px] lg:px-[100px]">
        <div
          ...
          style={{
            ...
            paddingRight: isMobile ? 0 : "40px", // ✅ 40px padding on desktop for last item
          }}
        >
        ...
        {/* ✅ Custom Mobile View More Button */}
