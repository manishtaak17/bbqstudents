...
const page = () => {
    ...
    return (
        <>
            ...
            <section className='container mb-[86px] md:mb-[70px]'>
                <div className="min-h-screen ">

                    <div className="max-w-[1205px] mx-auto">
                        <div className='flex items-center justify-start gap-[19px] w-full mb-[0px] md:mb-[41px]'>
                            <span className='inline-block size-3 bg-darkgray1 '></span>
                                ...
                                <AnimatePresence initial={false}>
                                    {(showAll ? timelineData : timelineData.slice(0, 3)).map((item, index) => (
                                        <motion.div
                                            ...
                                            className="flex justify-between items-center gap-5 border-b border-black pt-11 pb-3"
                                        >
                                            <div className="flex-1">
                                                <h3 className="font-firaSans-condensed font-medium text-[24px] text-brown leading-[30px] mb-2.5">
                                                    {item.title}
                                                </h3>
                                                <p className="font-firaSans-condensed font-normal text-[18px] text-darkgray leading-[27px]">
                                                    {item.description}
                                                </p>
                                            </div>
                                            <div className="w-full max-w-[105px] h-[139px] overflow-hidden">
                                                <img
                                                    src={item.image}
                                                    alt={item.title}
                        ...
                        {/* Desktop Layout */}
                        <div className="hidden md:flex gap-[40px] justify-between">


                            {/* List */}
                            <div className="w-[60%] max-w-[581px]">
                                <div className="space-y-0 mt-[-33px]">
                                    {timelineData.map((item, index) => (
                                        <motion.div
                                            key={index}
                                            className={`py-4 lg:py-8 border-b border-black last:border-0 relative cursor-pointer transition-all duration-300 hover:scale-102 ${selectedIndex === index ? '' : ''
                                                }`}
                                        ...
                                        >
                                            <div className="transition-all duration-300   ">
                                                <h4
                                                    className={`text-brown mb-2.5 font-firaSans-condensed font-semibold text-[28px] leading-[39px] lg:text-[35px] lg:leading-[44px] tracking-[-1%] ${selectedIndex === index ? 'text-darkpink' : 'text-brown'
                                                        }`}
                                                >
                                                    {item.title}
                                                </h4>
                                                <p
                                                    className={`font-firaSans-condensed leading-[27px] lg:leading-[140%] font-normal text-[18px] lg:text-[22px] transition-colors duration-300 ${selectedIndex === index ? 'text-darkgray' : 'text-darkgray'
                                                        }`}
                                                >
                                                    {item.description}
                                                </p>
                            ...
                            <div className="w-[40%] max-w-[452px] sticky top-8">
                                    ...
                                    >
                                        <div className="relative overflow-hidden">
                                            <img
                                                ...
                                                className="w-full max-w-[452px] h-[400px] lg:h-[600px] object-cover"
                                            />
                                        </div>
                                        <div className="p-0">
                                            <motion.h3
                                                ...
                                                className="font-firaSans text-[18px] leading-[27px] font-normal text-black mt-[12px]"
                                            >
                                                {selectedItem.title}
                                            </motion.h3>
                                        </div>
